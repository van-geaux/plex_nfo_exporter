...
- `get_image_paths`, `sync_alternate_image` (custom image patterns, media-type-specific and per-image fallback, hardlink/copy behavior); `process_content` verifies alternate synchronization after primary success
